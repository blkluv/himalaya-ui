...
<Playground
  ...
  scope={{ Image }}
  code={`
<Image width="280px" height="160px" src="/images/himalaya-banner.png" />
`}
/>
...
<Image width="280px" height="160px"
  src="http://www.deelay.me/2000/https://nftv.luvnft.com/images/himalaya-banner.png" />
`}
/>
...
<Playground
  ...
  code={`
<Image.Browser url="https://nftv.luvnft.com/guide/introduction" anchorProps={{ rel: 'nofollow' }}>
  <Image width="525px" height="300px" src="/images/himalaya-banner.png" />
</Image.Browser>
`}
/>
...
<Playground
  ...
  scope={{ Image, Display, Code }}
  code={`
<Image.Browser url="https://nftv.luvnft.com/guide/introduction" invert>
  <Image width="525px" height="300px" src="/images/himalaya-banner-dark.png" />
</Image.Browser>
`}
/>
...
<Display shadow caption={<p>Set the <Code>height</Code> to reduces the possibility of page rerender.</p>}>
  <Image height="246px" src="/images/himalaya-banner-text.png" />
</Display>
`}
/>
...
() => {
  ...
  return <Image width="50px" height="50px" src={svg} />
}
`}
/>

<Attributes edit="/pages/components/image.mdx">
