...
The `Keyboard` can only display layout styles, if you need to bind the keyboard events, please read subsection [useKeyboard](/web5/use-keyboard).
...
<Attributes edit="/pages/components/keyboard.mdx">
