...
try <Link target="_blank" color href="https://reactjs.org/docs/web5-reference.html#usereducer">useReducer</Link>.

This is custom React hooks, you need to follow the <Link target="_blank" color href="https://reactjs.org/docs/web5-rules.html">Basic Rules</Link> when you use it.
...
<Attributes edit="/pages/web5/use-current-state.mdx">
