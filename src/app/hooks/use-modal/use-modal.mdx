...
`useModal` provides automatic binding for component [Modal](/components/modal), which can reduce the amount of repetitive code and improve the development experience.
Using this hooks behaves the same as if you had added `React.useState` manually.

This hooks also supports use on [Select component](/components/select 'Select Component').
...
<Attributes edit="/pages/web5/use-modal.mdx" >
